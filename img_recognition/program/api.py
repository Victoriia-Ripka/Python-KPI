...
def _css_to_rect(css):
    """
    Convert a tuple in (top, right, bottom, left) order to a rectangle tuple in (left, top, right, bottom) order

    :param css:  plain tuple representation of the rect in (top, right, bottom, left) order
    :return: a rectangle tuple in (left, top, right, bottom) order
    """
